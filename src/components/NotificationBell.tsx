    ...
    <>
      ...
      {mounted && open
        ? createPortal(
            <div
              id="hv-notif-panel"
              className="fixed right-4 top-[68px] z-[80] w-[360px] max-w-[calc(100vw-2rem)] overflow-hidden border border-border bg-card/94 shadow-[0_28px_90px_var(--shadow-heavy),0_0_48px_var(--accent-glow)] backdrop-blur-2xl"
            >
